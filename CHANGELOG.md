...
* **agents:** a decision band over six consoles, not a column beside a grid ([4d1712e](https://github.com/VforVitorio/F1-StratLab/commit/4d1712e5efe73fa50959e8ddb20b3b5dc0ea7241)), closes [#1014](https://github.com/VforVitorio/F1-StratLab/issues/1014)
* **agents:** an idle console speaks to the reader, and ALERT stops being a colour ([ef039a2](https://github.com/VforVitorio/F1-StratLab/commit/ef039a205e351b73e5ee4180dbbac5939f4d3954)), closes [#1029](https://github.com/VforVitorio/F1-StratLab/issues/1029)
* **agents:** every console carries its model detail, reachable without a mouse ([e1e305b](https://github.com/VforVitorio/F1-StratLab/commit/e1e305b75caab6a9eb157d9af8a25292d8b34f02)), closes [#1018](https://github.com/VforVitorio/F1-StratLab/issues/1018)
* **agents:** project where a stop taken on this lap rejoins ([d0b35bd](https://github.com/VforVitorio/F1-StratLab/commit/d0b35bd991925b9fcb6f9bee0182ce7b980696c5))
* **agents:** the action is text on the panel, not a filled button ([1efe46a](https://github.com/VforVitorio/F1-StratLab/commit/1efe46a66da50c18f768a56f78f1b9b4dcba9fda)), closes [#1016](https://github.com/VforVitorio/F1-StratLab/issues/1016)
* **agents:** the pace chart says where its prediction stopped ([5aa7bb0](https://github.com/VforVitorio/F1-StratLab/commit/5aa7bb0a8d2d8d787ce90691ae4c38883ac7d17f)), closes [#1033](https://github.com/VforVitorio/F1-StratLab/issues/1033)
* **agents:** the PIT console stops crying wolf, and RADIO ranks severity over recency ([480bcdb](https://github.com/VforVitorio/F1-StratLab/commit/480bcdb52f3e031fee670dc26eb93783eeda4f1e)), closes [#1031](https://github.com/VforVitorio/F1-StratLab/issues/1031)
* **agents:** the PLAN module draws the race on one lap axis ([25ae167](https://github.com/VforVitorio/F1-StratLab/commit/25ae16733552698650228a837d4350675bbb3ffa)), closes [#1022](https://github.com/VforVitorio/F1-StratLab/issues/1022)
* **agents:** the WHY module replaces the reasoning tab panel ([c991acf](https://github.com/VforVitorio/F1-StratLab/commit/c991acf6c74dfd6b4d42172727d19fee61b747c3)), closes [#1020](https://github.com/VforVitorio/F1-StratLab/issues/1020)
* **arcade:** broadcast the telemetry span since the last tick, not a single sample ([522ff41](https://github.com/VforVitorio/F1-StratLab/commit/522ff41c538f4e38b0094973058a245b840dfc8c))
* **arcade:** carry the rejoin readout on its own wire field ([21f8c3a](https://github.com/VforVitorio/F1-StratLab/commit/21f8c3a1b09668dbb4011fd49cfe9c17ea7bb8a3))
* **arcade:** publish a telemetry span per driver, schema v2 ([6421461](https://github.com/VforVitorio/F1-StratLab/commit/64214612c736e845fc2cada1803e1486a337ca35)), closes [#1048](https://github.com/VforVitorio/F1-StratLab/issues/1048)
* **arcade:** publish the race order and the reveal coordinates on the wire ([9208b20](https://github.com/VforVitorio/F1-StratLab/commit/9208b202c86676601e8f1886d8b5870cee645ef0)), closes [#857](https://github.com/VforVitorio/F1-StratLab/issues/857)
* **arcade:** put location, global_t_min, active and rel_dist on the broadcast ([1979704](https://github.com/VforVitorio/F1-StratLab/commit/19797045358689d1b9f43b768d57064d48fdc657))
* **arcade:** settle the wire's field set under schema v2 ([286a263](https://github.com/VforVitorio/F1-StratLab/commit/286a26374b25b1ed5001faddaf178fe604ba78ca)), closes [#1040](https://github.com/VforVitorio/F1-StratLab/issues/1040) [#1043](https://github.com/VforVitorio/F1-StratLab/issues/1043) [#1046](https://github.com/VforVitorio/F1-StratLab/issues/1046) [#1052](https://github.com/VforVitorio/F1-StratLab/issues/1052)
* **arcade:** the wire publishes a decoded drs_open ([853d511](https://github.com/VforVitorio/F1-StratLab/commit/853d5118d1f49c477a9f5668221beb1f2ac9fc64))
* **arcade:** version and sequence the broadcast payload ([42e3572](https://github.com/VforVitorio/F1-StratLab/commit/42e357217199866e263f310a10618979449282ec))
* **cards:** own the Hugging Face cards, and guard them against the Hub ([df0fd2f](https://github.com/VforVitorio/F1-StratLab/commit/df0fd2f73992bf6e05f5472985dc6a57bd96e994))
* **docs:** add a full-screen view to the mermaid diagrams ([e227be3](https://github.com/VforVitorio/F1-StratLab/commit/e227be3b402cb0fee5f39f6f30365b6090d5b6d8))
* **docs:** add a light theme and a theme toggle ([000a2d9](https://github.com/VforVitorio/F1-StratLab/commit/000a2d9a61008c5a2b9ea2f41d58895c02121cee))
* **eval:** a paid measurement run now refuses by default and quotes the bill ([a7fed66](https://github.com/VforVitorio/F1-StratLab/commit/a7fed66979e313c5182179c4a7f8998d59a3455a))
* **eval:** scope the projection ground truth by season, and say which seasons on the report ([e5496f7](https://github.com/VforVitorio/F1-StratLab/commit/e5496f72a63ca2577893b25ed94c4ed5c6529d4b))
* **pitwall:** add a hover readout to every chart on both windows ([a2bea36](https://github.com/VforVitorio/F1-StratLab/commit/a2bea36c273238fef0e00549a1f6bfc528e57dcc))
* **pitwall:** add the PIT EXIT card to the AGENTS window ([e8d99ba](https://github.com/VforVitorio/F1-StratLab/commit/e8d99ba0a58a264d0491fa2d0e2e4066c932e9e8))
* **pitwall:** band 3, the race-pace grid, as a tab of the right column ([d68188d](https://github.com/VforVitorio/F1-StratLab/commit/d68188d15351498e3168a744f85098390046f2fd)), closes [#940](https://github.com/VforVitorio/F1-StratLab/issues/940)
* **pitwall:** band 3's race trace, the panel read with a vertical ruler ([2d382e0](https://github.com/VforVitorio/F1-StratLab/commit/2d382e079eb3cacb8abb449c3dd88b35f4b1257d)), closes [#944](https://github.com/VforVitorio/F1-StratLab/issues/944)
* **pitwall:** BESTS takes the room the drawing always gave it ([f504c2c](https://github.com/VforVitorio/F1-StratLab/commit/f504c2ce061a34c0b33b880c6603a00cd552490d))
* **pitwall:** fill the tower's sectors as the car crosses them ([25411d8](https://github.com/VforVitorio/F1-StratLab/commit/25411d8f6679ad888ef7a91a2d90986bcd21debb))
* **pitwall:** give the DATA window a band-1 status strip ([76aa3c2](https://github.com/VforVitorio/F1-StratLab/commit/76aa3c28ec61f0db4329e0431e697d03ac29da31))
* **pitwall:** give the DATA window a lap table to read, masked by the clock ([4a0b299](https://github.com/VforVitorio/F1-StratLab/commit/4a0b299b0e5c1dad9c61b984bb6d690ad19f7729))
* **pitwall:** make the shared formatters importable without Qt ([bdc34aa](https://github.com/VforVitorio/F1-StratLab/commit/bdc34aab2e3b87ee5aa3ace76b47b8fd7878c4e8))
* **pitwall:** per-driver trace accumulation, selection at render ([8eeecfd](https://github.com/VforVitorio/F1-StratLab/commit/8eeecfdc656626fd456aca1af49561b51fb8f7a7)), closes [#1050](https://github.com/VforVitorio/F1-StratLab/issues/1050)
* **pitwall:** put the orchestrator's key risks in the contingencies body ([86dc20a](https://github.com/VforVitorio/F1-StratLab/commit/86dc20a2b5c48eb9e12a10af859488722b27416b))
* **pitwall:** rank the session bests and colour the tower's sectors ([01f118e](https://github.com/VforVitorio/F1-StratLab/commit/01f118e999c38812ae18965ce5ce51710366dce2))
* **pitwall:** read the race's radio and RCM off disk, revealed lap by lap ([4718cd9](https://github.com/VforVitorio/F1-StratLab/commit/4718cd9361ba6cc278243086fdb2d8a402375888)), closes [#938](https://github.com/VforVitorio/F1-StratLab/issues/938)
* **pitwall:** render the orchestrator's contingencies in AGENTS ([3182b7c](https://github.com/VforVitorio/F1-StratLab/commit/3182b7ce65fe0f944f4b0fbbf299ac411a87a609))
* **pitwall:** render the radio and RCM feed under the ring ([1ba9a5d](https://github.com/VforVitorio/F1-StratLab/commit/1ba9a5da5e6303ee72711b2c37daacfc3fc0b804)), closes [#938](https://github.com/VforVitorio/F1-StratLab/issues/938)
* **pitwall:** render the timing tower in the DATA window's left column ([5d5f25d](https://github.com/VforVitorio/F1-StratLab/commit/5d5f25d5ae0192b09351872e8d12760530f9c91c))
* **pitwall:** serve the AGENTS view from the Qt window's own formatters ([22bd88f](https://github.com/VforVitorio/F1-StratLab/commit/22bd88f2ab70434ecbbc130584958cf4f898c241))
* **pitwall:** serve the same two windows on http://127.0.0.1, in any browser ([b258243](https://github.com/VforVitorio/F1-StratLab/commit/b2582436ef5beae1ca08b3ab2802a5cf81a00eff)), closes [#905](https://github.com/VforVitorio/F1-StratLab/issues/905)
* **pitwall:** ship the UI bundle in the wheel, and stop shipping the wrong files ([a3bba9c](https://github.com/VforVitorio/F1-StratLab/commit/a3bba9c466b581255f4f108aeeeaf582c882dd0b))
* **pitwall:** the AGENTS shell, header, split and six cards ([6dc96b2](https://github.com/VforVitorio/F1-StratLab/commit/6dc96b2349e3e555dc3c2a8fef8a7732afe2b75d))
* **pitwall:** the DATA window renders the own-car traces, 1:1 with the Qt panel ([bf17cd9](https://github.com/VforVitorio/F1-StratLab/commit/bf17cd954d1ca386f3f2a7f0cff7120e84af33a1)), closes [#894](https://github.com/VforVitorio/F1-StratLab/issues/894)
* **pitwall:** the DATA window renders the track ring, and the traces stop animating ([bb384ca](https://github.com/VforVitorio/F1-StratLab/commit/bb384ca5ff8533161b51f784eeca23e356a6085f)), closes [#895](https://github.com/VforVitorio/F1-StratLab/issues/895)
* **pitwall:** the four traces become six lanes on one axis ([e0e87af](https://github.com/VforVitorio/F1-StratLab/commit/e0e87afc31b975b619f96ff05a0befb31a88d1d2))
* **pitwall:** the orchestrator card and the scenario bars ([accee4b](https://github.com/VforVitorio/F1-StratLab/commit/accee4b358a2c29535c887ae50af1bb175098bfa))
* **pitwall:** the pace and tyre charts, in ECharts ([5681953](https://github.com/VforVitorio/F1-StratLab/commit/5681953d2dc96f8ae3e1946a6a9b9095cc961fc2))
* **pitwall:** the pace grid draws the whole race, not the part that has run ([dfe1325](https://github.com/VforVitorio/F1-StratLab/commit/dfe1325745f4c4aa5f9d09d89a271beea61fa5b9))
* **pitwall:** the pace grid yields to the wheel, and pass two of the gate ([a917693](https://github.com/VforVitorio/F1-StratLab/commit/a91769389d47e4b437ab267655b99feec007a102))
...
* **agents,arcade,pitwall,docs:** the correctness batch for 2.6 ([b893041](https://github.com/VforVitorio/F1-StratLab/commit/b8930418db41a8684606db0012054f792142ef65))
* **agents:** a tooltip too wide for either side clears its card instead of covering it ([4da50aa](https://github.com/VforVitorio/F1-StratLab/commit/4da50aad6417131a9a4752c3f7a4a877e8a147d0))
* **agents:** drop the guardrail line, which no producer can fill ([f0b0074](https://github.com/VforVitorio/F1-StratLab/commit/f0b0074b32cbea1849c0e21f9bc8434be4eb4ae1)), closes [#974](https://github.com/VforVitorio/F1-StratLab/issues/974)
* **agents:** no car ahead is an absence, not a zero ([273641b](https://github.com/VforVitorio/F1-StratLab/commit/273641b572e38fc496ac3aba59071a7042498e9b)), closes [#878](https://github.com/VforVitorio/F1-StratLab/issues/878)
* **agents:** say where the rival gap and pace delta actually go ([53f94fe](https://github.com/VforVitorio/F1-StratLab/commit/53f94fe3fbc9689839cb6f54a4f805480474f194))
* **agents:** single-source the LLM retry budget and raise it above one ([246bed0](https://github.com/VforVitorio/F1-StratLab/commit/246bed095d8da63d4570a5759fa381482afd80e5)), closes [#1153](https://github.com/VforVitorio/F1-StratLab/issues/1153)
* **agents:** stop two different weather defaults sharing one name ([5c8eaad](https://github.com/VforVitorio/F1-StratLab/commit/5c8eaade3e16af08f1236be8b1d3de0d8052242e)), closes [#1088](https://github.com/VforVitorio/F1-StratLab/issues/1088)
* **agents:** the exit gate's findings, three of them mine ([1bd2ad7](https://github.com/VforVitorio/F1-StratLab/commit/1bd2ad74003bb12178285a9233d166d200712049)), closes [#1037](https://github.com/VforVitorio/F1-StratLab/issues/1037)
* **arcade,pitwall:** close a pruned subscriber, and drop the AGENTS history when the producer restarts ([3f9f7c5](https://github.com/VforVitorio/F1-StratLab/commit/3f9f7c57f207214add09e75736eb84738687f219)), closes [#901](https://github.com/VforVitorio/F1-StratLab/issues/901)
* **arcade,pitwall:** the six findings of the pre-sprint-4 exit gate ([4d389e0](https://github.com/VforVitorio/F1-StratLab/commit/4d389e042c9fb1d21a6ecfb1c300949c132b4cb1))
* **arcade:** a missing driver costs his column, not the whole table ([5da4b72](https://github.com/VforVitorio/F1-StratLab/commit/5da4b72946ced1dc4d72762d79c24493c338e369)), closes [#1110](https://github.com/VforVitorio/F1-StratLab/issues/1110)
* **arcade:** bump the cache tag the pedal fix cannot otherwise reach ([83af6cd](https://github.com/VforVitorio/F1-StratLab/commit/83af6cd2cdf5f097640d067d74eefe90e69a7cf9))
* **arcade:** classify a final-lap retirement as out, not as the winner ([00dc882](https://github.com/VforVitorio/F1-StratLab/commit/00dc8822a068c9c7e91fd72b8497b3542011196e)), closes [#873](https://github.com/VforVitorio/F1-StratLab/issues/873)
* **arcade:** closing the replay window tears the companion down with it ([97507ba](https://github.com/VforVitorio/F1-StratLab/commit/97507baace105c57f21a3100937b068b1e2807b0))
* **arcade:** collapse the controls legend where it would cover a driver card ([fb7b753](https://github.com/VforVitorio/F1-StratLab/commit/fb7b7535e5ff10d7cb9dd64105bb66a40470ea51)), closes [#1096](https://github.com/VforVitorio/F1-StratLab/issues/1096)
* **arcade:** commit the script half of the DRS single-homing ([34d61d1](https://github.com/VforVitorio/F1-StratLab/commit/34d61d1c690a7691b6ee21b702ffa96f36d72e69))
* **arcade:** decide the pedal scale per session, derive rel_dist from distance, unblock the send ([d24a59e](https://github.com/VforVitorio/F1-StratLab/commit/d24a59e1320ea1a6795d1d8d3121dcbab3f45ed4))
* **arcade:** enforce the wire's non-finite promise and flag forward seeks ([d23dbde](https://github.com/VforVitorio/F1-StratLab/commit/d23dbde2cce9be532b8b0fefbbd24fab001df7f4))
* **arcade:** fetch a race's data when it is picked, and keep drawing while it loads ([ed1be4a](https://github.com/VforVitorio/F1-StratLab/commit/ed1be4abb7f08ef45ccc52a6c8bbbe022d3123e6)), closes [#1115](https://github.com/VforVitorio/F1-StratLab/issues/1115)
* **arcade:** group the menu's rows and weight the one that runs the agents ([452acfa](https://github.com/VforVitorio/F1-StratLab/commit/452acfae062f00c99e35c02adf8a3046d7997d18)), closes [#1101](https://github.com/VforVitorio/F1-StratLab/issues/1101)
* **arcade:** make the dev rig publish the per_agent keys the agents actually emit ([ba264d4](https://github.com/VforVitorio/F1-StratLab/commit/ba264d4fbfa8b36e90172436f9c3d587a1ae9686)), closes [#853](https://github.com/VforVitorio/F1-StratLab/issues/853)
* **arcade:** make the menu's strategy emphasis reach the glyphs on the first frame ([1366a38](https://github.com/VforVitorio/F1-StratLab/commit/1366a389f66d8a97a0956432f4bc58f0907f4c12)), closes [#1109](https://github.com/VforVitorio/F1-StratLab/issues/1109)
* **arcade:** name a cached session after the race it holds ([dd846a6](https://github.com/VforVitorio/F1-StratLab/commit/dd846a64261f5ca3ca9c6dacb8045eeb394b2768)), closes [#1119](https://github.com/VforVitorio/F1-StratLab/issues/1119)
* **arcade:** no position data is an absence, not a car on the grid ([5bb8986](https://github.com/VforVitorio/F1-StratLab/commit/5bb898609997695efb91609e5dec7fbdf53fd6a6)), closes [#886](https://github.com/VforVitorio/F1-StratLab/issues/886)
* **arcade:** rank the field on real race progress and read the gap at the line ([83550ea](https://github.com/VforVitorio/F1-StratLab/commit/83550ea8d8e455d460270fd87df6e14f0e9d15c1))
* **arcade:** render an absent weather reading instead of raising ([85cd36f](https://github.com/VforVitorio/F1-StratLab/commit/85cd36fa0d3eee5fde5cb3045f7dbfdb52e7ba11))
* **arcade:** replace the fabricated leaderboard gap with the at-the-line interval ([b75d105](https://github.com/VforVitorio/F1-StratLab/commit/b75d105d5a6551ef88ea69e3b731eabc439eb520))
* **arcade:** resolve every menu round to a real dataset folder, and follow the calendar ([8acc528](https://github.com/VforVitorio/F1-StratLab/commit/8acc52876a3b2480a1f00da440094c658d25307e)), closes [#1116](https://github.com/VforVitorio/F1-StratLab/issues/1116)
* **arcade:** scale the launch menu with the window it is given ([2a0cfa3](https://github.com/VforVitorio/F1-StratLab/commit/2a0cfa3c2b9791d1e66ebc8b724bd855eac3d8aa)), closes [#1100](https://github.com/VforVitorio/F1-StratLab/issues/1100)
* **arcade:** size the menu's focus band to the form it highlights ([73dd609](https://github.com/VforVitorio/F1-StratLab/commit/73dd6097e0e747a8a4487b7fbba8e7e6ee4232de)), closes [#1099](https://github.com/VforVitorio/F1-StratLab/issues/1099)
* **arcade:** sort the shared lap-boundary sample stably ([2ef81e3](https://github.com/VforVitorio/F1-StratLab/commit/2ef81e35dd146417c46a218201af6af877ae51c6))
* **arcade:** stop broadcasting the no-position car at the start line ([0672952](https://github.com/VforVitorio/F1-StratLab/commit/0672952ec7dadb9ba4797791870ace5fc7b7a3c5)), closes [#856](https://github.com/VforVitorio/F1-StratLab/issues/856)
* **arcade:** take the chequered flag from the official classification, not from odometer noise ([063c957](https://github.com/VforVitorio/F1-StratLab/commit/063c957ef16b31e9b6c4e523007a68018af97e19)), closes [#879](https://github.com/VforVitorio/F1-StratLab/issues/879)
* **arcade:** tell taking the chequered flag apart from retiring ([3e867f1](https://github.com/VforVitorio/F1-StratLab/commit/3e867f1fc25a7b12c7c093defdf7fe942f5b9d98)), closes [#855](https://github.com/VforVitorio/F1-StratLab/issues/855)
* **arcade:** the discrete telemetry channels stop being interpolated ([e06614d](https://github.com/VforVitorio/F1-StratLab/commit/e06614d641d61c9de73faeb675ef120bee547bd1))
* **arcade:** the DRS open set had three homes, and the comment named the wrong code ([24ab982](https://github.com/VforVitorio/F1-StratLab/commit/24ab982bceed77632fa42de29cc12d46c51adb59))
* **arcade:** the P3 remainder of the Fable wire gate ([9641cf1](https://github.com/VforVitorio/F1-StratLab/commit/9641cf1d43f69e2e2f19751c76257ff98124e146))
* **arcade:** wire no_llm through to the strategy pipeline ([b61c41a](https://github.com/VforVitorio/F1-StratLab/commit/b61c41a77d0babd184d55f5d349e9f1d4969f357)), closes [#1155](https://github.com/VforVitorio/F1-StratLab/issues/1155)
* **data:** fetch a race's radio corpus by circuit, not by country ([b788a6b](https://github.com/VforVitorio/F1-StratLab/commit/b788a6bcbc09c6abdb11b1720130a2ee0700cfe9))
* **data:** null a TyreLife the feed republished on an unchanged set ([577d6ba](https://github.com/VforVitorio/F1-StratLab/commit/577d6ba92c819c54533c66dfe83a8807e7fa145a))
* **data:** pull the NLP label sets and the NER config the eval tier reads ([600c138](https://github.com/VforVitorio/F1-StratLab/commit/600c138efb261118cea999cda2e229fdc993a994)), closes [#1130](https://github.com/VforVitorio/F1-StratLab/issues/1130) [#1146](https://github.com/VforVitorio/F1-StratLab/issues/1146)
* **data:** pull the two artefacts a fresh install needs to import the orchestrator ([05a806c](https://github.com/VforVitorio/F1-StratLab/commit/05a806ce5680e97cf496ac16010809d6c568f2a4)), closes [#837](https://github.com/VforVitorio/F1-StratLab/issues/837)
* **engine:** open the draw capture on the no-LLM profile too ([5f9776f](https://github.com/VforVitorio/F1-StratLab/commit/5f9776fe4427dd0e23f5a0bc04a950e8da11c776))
* **eval:** a hardcoded '(measured)' sentence that the rows could not measure ([b912398](https://github.com/VforVitorio/F1-StratLab/commit/b91239860afce9afd094c64d324d6a547fee113f))
* **eval:** a lap measured from two window starts is not a repeat of itself ([60a1bb1](https://github.com/VforVitorio/F1-StratLab/commit/60a1bb1c91924fba69be3f2ef64e4b8fb1a65a23))
* **eval:** close the gate's remaining findings ([d5facb6](https://github.com/VforVitorio/F1-StratLab/commit/d5facb622e802ad34d201f045ee035f56e18158b))
* **eval:** count DISTINCT laps, not rows, when reporting coverage ([617b3de](https://github.com/VforVitorio/F1-StratLab/commit/617b3de0a54bebf3e605fa151b3aaa84fe58f4b9))
* **eval:** decision-modes uses the product's RaceState, not a private copy ([a22c97d](https://github.com/VforVitorio/F1-StratLab/commit/a22c97d5514ae14e78f0e30822a9de5a2dddd964))
* **eval:** exclude tags from harness_sha so it stays a short sha ([d6490d9](https://github.com/VforVitorio/F1-StratLab/commit/d6490d94eb6d9c34b7b74335df13564ded48a4a4))
* **eval:** gate the NLP golden tests on their label files, not just the weights ([6703920](https://github.com/VforVitorio/F1-StratLab/commit/67039205b8c6393e0dde847b38eb21ec760c4b93))
* **eval:** make the download guards actually guard, and publish the alert corpus ([39d421d](https://github.com/VforVitorio/F1-StratLab/commit/39d421d0a3f41b05df7685494c04770c5644cfa4))
* **eval:** mark harness_sha dirty instead of naming the parent commit ([18f2c6b](https://github.com/VforVitorio/F1-StratLab/commit/18f2c6b656206fa107e735818ae439e2a8dd9fdb)), closes [#1152](https://github.com/VforVitorio/F1-StratLab/issues/1152)
* **eval:** spell an empty artifact set as none in the report header ([4e05c05](https://github.com/VforVitorio/F1-StratLab/commit/4e05c056d52c4ef78a42900ba67d46f049c79744))
* **pitwall,arcade:** un-clip the tooltip for real and close the third audit round ([be76986](https://github.com/VforVitorio/F1-StratLab/commit/be76986b499eded751c28e03ded832e867ae65aa)), closes [#874](https://github.com/VforVitorio/F1-StratLab/issues/874)
* **pitwall,eval:** the fit callback stops closing over its own output, and calibration.md is regenerated ([fd33e47](https://github.com/VforVitorio/F1-StratLab/commit/fd33e47c1e15d82a2713647cba2fe690a94e0f83))
* **pitwall:** a best trap speed is the fastest, not the slowest ([92681f1](https://github.com/VforVitorio/F1-StratLab/commit/92681f16272aace3cb683bb87b2d332ab3f786e0))
* **pitwall:** a chart that unmounts never comes back, and four smaller defects in band 4 ([8280a8e](https://github.com/VforVitorio/F1-StratLab/commit/8280a8e457f1c775da8eacab662b416f1a4783ea)), closes [#900](https://github.com/VforVitorio/F1-StratLab/issues/900)
* **pitwall:** a dead feed stops looking like a live one ([f580922](https://github.com/VforVitorio/F1-StratLab/commit/f5809220a5b84efffe7fcd080986210e124c3dcd)), closes [#982](https://github.com/VforVitorio/F1-StratLab/issues/982)
* **pitwall:** a driver code you can read, and one arithmetic for a lap time ([2a745f7](https://github.com/VforVitorio/F1-StratLab/commit/2a745f7c22969eb984658c439bdf09395aaa3cb9)), closes [#985](https://github.com/VforVitorio/F1-StratLab/issues/985)
* **pitwall:** a posture stops wearing the alarm colour ([2caa23e](https://github.com/VforVitorio/F1-StratLab/commit/2caa23e8e7ec0ba93f333e92f3ab18e312cf38ee))
* **pitwall:** a stop is a tyre change, not a trip down the pit lane ([d07a10a](https://github.com/VforVitorio/F1-StratLab/commit/d07a10a2f11623a5a3158d7318f7b9f0676e606b)), closes [#981](https://github.com/VforVitorio/F1-StratLab/issues/981)
* **pitwall:** AGENTS cards say when they are hiding content ([e6db8dd](https://github.com/VforVitorio/F1-StratLab/commit/e6db8dd4ce8caf3b72b27fc4cef2ac9862695a4a)), closes [#1077](https://github.com/VforVitorio/F1-StratLab/issues/1077)
* **pitwall:** an empty window says whether the socket is up ([9d452a9](https://github.com/VforVitorio/F1-StratLab/commit/9d452a91071e4470ae9a98d40845e453fff6fa71))
* **pitwall:** band 4 compares two laps, not two instants ([9c57384](https://github.com/VforVitorio/F1-StratLab/commit/9c573847cf5ca2ef54c0b987b0ac95130b36bd26))
* **pitwall:** BESTS degrades to its leaders instead of falling off the column ([95dbb97](https://github.com/VforVitorio/F1-StratLab/commit/95dbb97c8d06d8195354babeee92d44e861c1191)), closes [#979](https://github.com/VforVitorio/F1-StratLab/issues/979)
* **pitwall:** BESTS runs out of DATA before it runs out of room ([9d7eabb](https://github.com/VforVitorio/F1-StratLab/commit/9d7eabb35f2dfa74b596305d6b845048c9200e1a))
* **pitwall:** BESTS uses the room it has, and recovers from a resize ([a9aa990](https://github.com/VforVitorio/F1-StratLab/commit/a9aa9907d24d51a6dec3f545fb4747c141fbe20c)), closes [#1074](https://github.com/VforVitorio/F1-StratLab/issues/1074)
* **pitwall:** both windows are born taller than the desktop, hiding both status bars ([c753f2c](https://github.com/VforVitorio/F1-StratLab/commit/c753f2c25a80a4de93a08e5e1a00907ee02c9a45)), closes [#899](https://github.com/VforVitorio/F1-StratLab/issues/899)
* **pitwall:** budget the whole radio line, not just its message ([9e955a9](https://github.com/VforVitorio/F1-StratLab/commit/9e955a9c1f7fdf75bffb169f78276f09b291a93c))
* **pitwall:** close the exit gate's findings on the AGENTS port ([50b5ebf](https://github.com/VforVitorio/F1-StratLab/commit/50b5ebfee382689a61e8ede0831d62fe38d5c994)), closes [#870](https://github.com/VforVitorio/F1-StratLab/issues/870)
* **pitwall:** close the four the exit gate found in band 3 and the feed ([9c6e872](https://github.com/VforVitorio/F1-StratLab/commit/9c6e872e24bcc228ba6c25681095313323fe5601))
* **pitwall:** close the three the gate found in the fixes themselves ([cbadc54](https://github.com/VforVitorio/F1-StratLab/commit/cbadc54b826c616d6a30ff21992b50f1fd86369c))
* **pitwall:** drop the file: sniff that [#996](https://github.com/VforVitorio/F1-StratLab/issues/996) turned into a lie ([22bda91](https://github.com/VforVitorio/F1-StratLab/commit/22bda91cfb23b039fd2c4299f56e957640d39466))
* **pitwall:** every harness measures the client area the window really has ([bc15f7a](https://github.com/VforVitorio/F1-StratLab/commit/bc15f7a6c4fca61b90d0ba74e3a3c7ccca20018b)), closes [#1009](https://github.com/VforVitorio/F1-StratLab/issues/1009)
* **pitwall:** every harness page reports its own console, and four stubs stop 404ing ([a522920](https://github.com/VforVitorio/F1-StratLab/commit/a522920fe8568c8341594b0e2bf19ad0006d69fa)), closes [#1012](https://github.com/VforVitorio/F1-StratLab/issues/1012)
* **pitwall:** follow a restarted producer instead of freezing on the dead race ([998c7ed](https://github.com/VforVitorio/F1-StratLab/commit/998c7ed5c1606692f34cc617786a28a2944236b3)), closes [#854](https://github.com/VforVitorio/F1-StratLab/issues/854)
* **pitwall:** four agent cards stop reserving 140px for a chart they do not have ([2b58a06](https://github.com/VforVitorio/F1-StratLab/commit/2b58a0625694204e605831c0e32c5b578e424d81))
* **pitwall:** four more the gate found, three of them in comments ([1f49a2a](https://github.com/VforVitorio/F1-StratLab/commit/1f49a2a115f5c2ef2ae17c3c155e94b1932545ae))
* **pitwall:** gate the tooltip hover on a class the component sets ([7361e86](https://github.com/VforVitorio/F1-StratLab/commit/7361e86fdbb4ff04ee16d947baee2a981442c881))
* **pitwall:** guard the wiring that fixes the 404, not just the rule ([43da5a0](https://github.com/VforVitorio/F1-StratLab/commit/43da5a06248dbe81626df5a881cfbbc82e5b7305))
* **pitwall:** hide the scrollbars inside the AGENTS cards, and stop the DATA cursor shimmering ([31b2b21](https://github.com/VforVitorio/F1-StratLab/commit/31b2b2174ed22f84a320f1499fa6cd1bf814ae0b)), closes [#907](https://github.com/VforVitorio/F1-StratLab/issues/907)
* **pitwall:** keep the screenshot server inside its own directory ([544a78d](https://github.com/VforVitorio/F1-StratLab/commit/544a78db21a18d4313789b1093949f489ce018cf))
* **pitwall:** keep the status bar up while streaming and stop the card clipping its tooltip ([6ae661d](https://github.com/VforVitorio/F1-StratLab/commit/6ae661dfc735519d59704018590fb2951a797a8b)), closes [#874](https://github.com/VforVitorio/F1-StratLab/issues/874)
* **pitwall:** leaving the TRACES tab no longer loses the rest of the lap ([445d240](https://github.com/VforVitorio/F1-StratLab/commit/445d2407517852868355d427b865d0bff0e2414f))
* **pitwall:** paint the own car in its own team colour ([144504f](https://github.com/VforVitorio/F1-StratLab/commit/144504fdbca0c3833304222489026a2896439a67))
* **pitwall:** read the bundle tree without a second stat call ([3617c99](https://github.com/VforVitorio/F1-StratLab/commit/3617c995d1e5b892e8f15fb38c839c60e52cf7ce))
* **pitwall:** read the screenshot bundle into memory instead of serving paths ([e02b570](https://github.com/VforVitorio/F1-StratLab/commit/e02b57019f77598e7e0f06664338402accafe775))
* **pitwall:** size the contingency fixtures to what a real lap returns ([562656a](https://github.com/VforVitorio/F1-StratLab/commit/562656aaf9816ec950532e2b458f51aaabc664b9))
* **pitwall:** stop building a cmd line out of the dist path in clean-dist ([34b29ba](https://github.com/VforVitorio/F1-StratLab/commit/34b29baf06fb0a1432d36ecbf883218166bbc2fd))
* **pitwall:** stop the AGENTS charts redrawing themselves ten times a second ([808f459](https://github.com/VforVitorio/F1-StratLab/commit/808f4594e49405972cc0f501f42f58fa132fa59d))
* **pitwall:** stop the pre-warm thread when the host is torn down ([5aa099f](https://github.com/VforVitorio/F1-StratLab/commit/5aa099f4c2b765b53a5c7e6a425753fca6d96b0e))
* **pitwall:** stop the traces header note sizing the whole window ([c3da39d](https://github.com/VforVitorio/F1-StratLab/commit/c3da39dd85a599217b938d2fc2a004a7a9aad300)), closes [#1073](https://github.com/VforVitorio/F1-StratLab/issues/1073)
* **pitwall:** take the laps and the radio as one snapshot, not two reads ([3ab59d5](https://github.com/VforVitorio/F1-StratLab/commit/3ab59d54c0595dccc8b34c34a53fc85f6ac94122))
* **pitwall:** the AGENTS header says whether the track is neutralised ([caf1cfd](https://github.com/VforVitorio/F1-StratLab/commit/caf1cfd487e6cc0b3848646c24d6aef71649f494))
* **pitwall:** the AGENTS hover covered the card it belongs to ([e690366](https://github.com/VforVitorio/F1-StratLab/commit/e6903668d021bd54602dd2e7f165926a882d07a8)), closes [#912](https://github.com/VforVitorio/F1-StratLab/issues/912)
* **pitwall:** the alarm and the decision become legible on their own fills ([b893772](https://github.com/VforVitorio/F1-StratLab/commit/b893772a43ed7d8907a00bbfe0b6ee58802bb16b))
* **pitwall:** the BESTS fit guard asserted a rule the panel does not follow ([a642986](https://github.com/VforVitorio/F1-StratLab/commit/a642986ae8a207b1c3a5d0858d480c73369d7b34))
* **pitwall:** the connection a caller holds, and the laps it can actually see ([eea234d](https://github.com/VforVitorio/F1-StratLab/commit/eea234d2fe7191a15ca27cc2dc93fcb6cd24d2be))
* **pitwall:** the control targets are 26 px from the stylesheet, not from the font ([0169b27](https://github.com/VforVitorio/F1-StratLab/commit/0169b278d43bb5cdbf24638e21c8345c87879716))
* **pitwall:** the dev producer stops raising a red alarm that says nothing is wrong ([c8cad0c](https://github.com/VforVitorio/F1-StratLab/commit/c8cad0c5bf7016280f1e28b5c4b78080070e8b54))
* **pitwall:** the eviction signals survive a discarded tick ([f4c2bf2](https://github.com/VforVitorio/F1-StratLab/commit/f4c2bf21afa97277f312fe9194ef224fceded27b)), closes [#1060](https://github.com/VforVitorio/F1-StratLab/issues/1060)
* **pitwall:** the exit gate's findings on this sprint's own work ([910ad54](https://github.com/VforVitorio/F1-StratLab/commit/910ad54cc2190d89be751dfac59ae5dfa4a49337))
* **pitwall:** the five the Fable gates found in band 3 ([472fb56](https://github.com/VforVitorio/F1-StratLab/commit/472fb561637ec125625c52125c23fd4130c82e25))
* **pitwall:** the gate refuted the radio's counter twice, and four guards were blind ([0be00ec](https://github.com/VforVitorio/F1-StratLab/commit/0be00ec13c3f1fa38734d2e7e17a7881aebc0db2))
* **pitwall:** the pace grid fits the laptop, and its newest lap stops walking ([43b7c45](https://github.com/VforVitorio/F1-StratLab/commit/43b7c455503db4d089755d811b1380dc74f61ac7)), closes [#978](https://github.com/VforVitorio/F1-StratLab/issues/978)
* **pitwall:** the RADIO popup carries the NLP corrections ([cac9dc7](https://github.com/VforVitorio/F1-StratLab/commit/cac9dc7d88763235622482efc042fb4226684b51))
* **pitwall:** the rival is drawn in its own team colour ([956aed3](https://github.com/VforVitorio/F1-StratLab/commit/956aed37fd0ec461e269558bf66d2b2b5c8950f5))
* **pitwall:** the scenario panel says which plan was taken, and which was only scored ([f3d8e24](https://github.com/VforVitorio/F1-StratLab/commit/f3d8e2449dafd457fd0421cb06025a8c2c6e0bc6))
* **pitwall:** the scroll guard creates the overflow it needs instead of borrowing it ([77b4579](https://github.com/VforVitorio/F1-StratLab/commit/77b4579716916215dbb47ba21c7bd554e9bbd6ed))
* **pitwall:** the scroll-reachability check depended on the machine it ran on ([8f81185](https://github.com/VforVitorio/F1-StratLab/commit/8f81185e3b1cd355bc38ed483b9d985305e800d8))
* **pitwall:** the socket state carries its own colour, from one map ([6b4d18a](https://github.com/VforVitorio/F1-StratLab/commit/6b4d18a7259d0c72ef778199ac8169ff3b28b55b)), closes [#1024](https://github.com/VforVitorio/F1-StratLab/issues/1024)
* **pitwall:** the tire chart's y axis stops hiding the trend it exists to show ([ff354c1](https://github.com/VforVitorio/F1-StratLab/commit/ff354c163da36ba7dfc68b4f69072b2677e27f6c))
* **pitwall:** the TIRE console reports what the wear has cost ([0dae0ce](https://github.com/VforVitorio/F1-StratLab/commit/0dae0ce5d0a7cc055c64ab2f4d2284c9ee2379e2))
* **pitwall:** the window says which state it is in ([ca7c17d](https://github.com/VforVitorio/F1-StratLab/commit/ca7c17d598e6758c4b913c1dace568a4ce216fc8)), closes [#980](https://github.com/VforVitorio/F1-StratLab/issues/980) [#983](https://github.com/VforVitorio/F1-StratLab/issues/983) [#984](https://github.com/VforVitorio/F1-StratLab/issues/984)
* **pitwall:** the windows load over one transport, and what the exit gate found ([af92229](https://github.com/VforVitorio/F1-StratLab/commit/af922297588e5b8c796e2a75a45f299a9bccf618)), closes [#995](https://github.com/VforVitorio/F1-StratLab/issues/995)
* **pitwall:** use the real token names and skip the Qt palette check headlessly ([d46e8d6](https://github.com/VforVitorio/F1-StratLab/commit/d46e8d6b8d91a12444f37d7b36c3bd1cc3ad1b00))
* **pitwall:** wait for quiescence instead of assuming it, so the guard survives a slow runner ([79c77e6](https://github.com/VforVitorio/F1-StratLab/commit/79c77e61c57bc674f38d881b2eec2473b066429d))
* **pitwall:** what the design-iteration round found in this sprint's own work ([dbdf1a8](https://github.com/VforVitorio/F1-StratLab/commit/dbdf1a81e26adffbf168d480e0246387a1b6b39f))
* **rag:** a locked regulation store costs the regulation block, not every lap ([ea9c319](https://github.com/VforVitorio/F1-StratLab/commit/ea9c319ff5f8e81fbe97464cc80669b72b893945))
* **rag:** catch the exception qdrant really raises, not the one a docstring named ([6602917](https://github.com/VforVitorio/F1-StratLab/commit/6602917e8b31fa41dff7b45f06abcb9eb6ec3280))
* **rag:** make applicability conditions first-class, and stop the question presupposing a restriction ([334b3f0](https://github.com/VforVitorio/F1-StratLab/commit/334b3f026aea9fd58cb1f28fad1051889b657106))
* **rag:** move lock detection out from behind the dataset, so its guard can run ([bf47ce7](https://github.com/VforVitorio/F1-StratLab/commit/bf47ce7b2ca0dc54df32d4388ca50af78054767d))
* **security:** close the second scanner round on main ([4545aa0](https://github.com/VforVitorio/F1-StratLab/commit/4545aa089b7d7c38043c5741f4cc9c31994b27df))
* **security:** close the three scanner findings the promotion surfaced ([a02482e](https://github.com/VforVitorio/F1-StratLab/commit/a02482ef7db847d76769c89ac08634f0b5ff90d4))
* **tests:** gate the capture guards on the model weights ([e07a21c](https://github.com/VforVitorio/F1-StratLab/commit/e07a21ce868a3d56ed1261b91e2bee22a1fdd5b9))
* **tests:** keep the projection golden collectable without model weights ([52e74bd](https://github.com/VforVitorio/F1-StratLab/commit/52e74bdee18983cb668e7974b0ac42c054457529))
* **webapp:** drop the Soon pills from six surfaces that all shipped ([85cc484](https://github.com/VforVitorio/F1-StratLab/commit/85cc4844aadb82c76db9be48666551784c447665))


### Performance

* **agents:** defer the LLM stack at import and batch N25's bootstrap interval ([2aa80e8](https://github.com/VforVitorio/F1-StratLab/commit/2aa80e87cdf753f5be8369a217b258f16c882a5d))
* **arcade:** build and encode the broadcast off the pyglet thread ([66d0275](https://github.com/VforVitorio/F1-StratLab/commit/66d0275392db480b4ff3a59299837c2e55c6b1d9)), closes [#1049](https://github.com/VforVitorio/F1-StratLab/issues/1049)


### Documentation

* **agents,simulation:** tidy the remaining sub-agent and simulation docstrings ([e31f586](https://github.com/VforVitorio/F1-StratLab/commit/e31f586eb4b2dfce29cbb5e20495d08447775971))
* **agents:** the plan caption's comment stops claiming a hole that was open ([1abc8df](https://github.com/VforVitorio/F1-StratLab/commit/1abc8dfcff4cd474ac29116486ce61b2491c1100))
* **agents:** tidy the docstrings in the orchestrator and two sub-agents ([67dedcd](https://github.com/VforVitorio/F1-StratLab/commit/67dedcd925c65be2cd3473dc045f31572a3a62a5))
* **arcade,tests:** tidy the arcade and guard-suite docstrings ([5b5abe0](https://github.com/VforVitorio/F1-StratLab/commit/5b5abe021fab3702545764e8f01e8c2efe868148))
* **arcade:** correct the geometry comments and guards the closing gate refuted ([3faa844](https://github.com/VforVitorio/F1-StratLab/commit/3faa84456d09cb6941e2669d17bf853074361614)), closes [#1111](https://github.com/VforVitorio/F1-StratLab/issues/1111)
* **arcade:** describe the AGENTS window the quick start actually opens ([22a08db](https://github.com/VforVitorio/F1-StratLab/commit/22a08dbd3605f4282f260990241627f81892c2bc)), closes [#1163](https://github.com/VforVitorio/F1-StratLab/issues/1163)
* **arcade:** the module docstring pointed at a note that was deleted ([ed98ebe](https://github.com/VforVitorio/F1-StratLab/commit/ed98ebe7a6305f1f431ca513cd81c7e7686068a9))
* **audits:** account for the deterministic arm's lap shortfall, and refuse the comparison it invites ([ae6b98d](https://github.com/VforVitorio/F1-StratLab/commit/ae6b98d3dc9071622044d168a19cefc4d8363c59))
* **audits:** confirm the Budapest verdict through the scorer, not the action list ([4b26f39](https://github.com/VforVitorio/F1-StratLab/commit/4b26f39f8ef156bef881b45b4890162e73e3afdb))
* **audits:** correct the cost figures, the three-lap probe was too short ([6164449](https://github.com/VforVitorio/F1-StratLab/commit/616444901386c9ba66ce8a4412ed563589c90548))
* **audits:** fix a fourth cost error the gate caught, and stop quoting the probe's latency as the mean ([0156673](https://github.com/VforVitorio/F1-StratLab/commit/01566734d6ed4dceeab6fcf7e1a8a763e4572ca7))
* **audits:** land the responsive and motion design gate report ([107ed0e](https://github.com/VforVitorio/F1-StratLab/commit/107ed0e491e86074f15e98ac174e5143e6688b22))
* **audits:** record the second gate, and the control it forced ([5a68278](https://github.com/VforVitorio/F1-StratLab/commit/5a68278e285337dac2e83fb94fafff3b9cf3f007))
* **audits:** refute my own two-window generalisation with the wider sample ([f30cf33](https://github.com/VforVitorio/F1-StratLab/commit/f30cf333c119a6d2e086859ba4b200e78a931e4d))
* **audits:** state where each of the four defects actually stands ([e0022b7](https://github.com/VforVitorio/F1-StratLab/commit/e0022b772d004c03606fe9f1c823f740307fb770))
* **audits:** stop presenting one arm's Monte Carlo scores as if both arms saw them ([a888b97](https://github.com/VforVitorio/F1-StratLab/commit/a888b97ce2315501c4f4be81ae9407a99d827112))
* **audits:** the Safety Car rule is real, and I said it was invented ([8c22d1e](https://github.com/VforVitorio/F1-StratLab/commit/8c22d1e9c929db02c728a4d319a105ac17725dab))
* **audits:** the unfinished sample is a decision, not a pending task ([28eeaa7](https://github.com/VforVitorio/F1-StratLab/commit/28eeaa7364faaf9cb4ddd2e0ea184ef33b2aa4c9))
* **audits:** update the paired contrast to 639 laps, and name what still biases it ([eddee11](https://github.com/VforVitorio/F1-StratLab/commit/eddee11f7b936b1ae3a6d72dfe6ab11dfa8aa478))
* close the en-dash ranges and the spaced percent signs ([2ae1bec](https://github.com/VforVitorio/F1-StratLab/commit/2ae1bec1daabf8b0c41618c710b3ad27da8710ba))
* correct four places that describe a sample or a layout that changed ([c7defd0](https://github.com/VforVitorio/F1-StratLab/commit/c7defd09a36f5dbab9e36f447db88d81a94726f6))
* **demo:** add the PITWALL demo video, its GIF and the three-window row ([46f526e](https://github.com/VforVitorio/F1-StratLab/commit/46f526e87d9b18b31da9879d33e94998f0b85244))
* **diagrams:** correct strategy_pipeline_flow against the code, sweep the label dashes ([be00a6e](https://github.com/VforVitorio/F1-StratLab/commit/be00a6e8aa6fca6805afa1a8fa400fc8200adf6c))
* **diagrams:** redraw the three diagrams that still show the Qt windows ([31b060d](https://github.com/VforVitorio/F1-StratLab/commit/31b060d6957d9e813dab79087be84f3605eb64ca)), closes [#1090](https://github.com/VforVitorio/F1-StratLab/issues/1090)
* drop a paragraph-opening 'and' in the traces spec ([5e1f915](https://github.com/VforVitorio/F1-StratLab/commit/5e1f9153caca244584169c62e92fc123ad77b698))
* drop the audit finding codes and the aphoristic closers ([85cd199](https://github.com/VforVitorio/F1-StratLab/commit/85cd199a4f7774a76c0bdd83c461bcb0ad72e466))
* drop the session references from the three PITWALL specs ([5344452](https://github.com/VforVitorio/F1-StratLab/commit/5344452eb7da3cc245133bac388110a7bb5c58a7))
* **eval:** make the decision-modes report say it is measured on two constant inputs ([d282261](https://github.com/VforVitorio/F1-StratLab/commit/d28226183b85309cd77084c8f4602977f1dbb22a))
* **eval:** measure the recalibration against one variable, not two ([20284d6](https://github.com/VforVitorio/F1-StratLab/commit/20284d6a28c760a8c291d6754270fb5c37f08743))
* **eval:** name the sample behind the decision-tier figures ([3e91804](https://github.com/VforVitorio/F1-StratLab/commit/3e9180487cb8bab4fb9509082e4faa193c863ee0))
* **eval:** the run stopped on an empty account, and the paired result is the opposite of what I first wrote ([840289a](https://github.com/VforVitorio/F1-StratLab/commit/840289adff8f1bb4269a38606cc64694dddb61dc))
* finish the writing pass over the documentation tree ([f541ee7](https://github.com/VforVitorio/F1-StratLab/commit/f541ee72333114041e04a7b922a032d4c896ebdf))
* fix a heading level, two bundled headings and a page narrating its own history ([9557057](https://github.com/VforVitorio/F1-StratLab/commit/95570575619e55c580b51c41fbff361b5703f5e4))
* I invented a press convention to rescue a thesis sentence, and applied it backwards elsewhere ([e9ba0a9](https://github.com/VforVitorio/F1-StratLab/commit/e9ba0a9c34bbd6ece26f54370d39a6a764a4e686))
* **multi-agent:** draw the routing edge the diagram was missing ([d297780](https://github.com/VforVitorio/F1-StratLab/commit/d297780cc3f70d299e8e5e355c01fe9bce0f3fea))
* pause contributions until v3.0.0, and finish the Qt sweep the last one missed ([bb22e28](https://github.com/VforVitorio/F1-StratLab/commit/bb22e2885fac3d1c963ab5c92e105aad4b52a7d1))
* **pitwall-ui:** drop the maintainer citations and correct four stale comments ([5b999f6](https://github.com/VforVitorio/F1-StratLab/commit/5b999f64c7260cf0fa0d596048e132f5f7735c35))
* **pitwall:** add sprints 8 and 9, the elevate pass, one per window ([a2193b6](https://github.com/VforVitorio/F1-StratLab/commit/a2193b615d9035f740f99d18b217e09157cd9dbe))
* **pitwall:** capture the Qt windows sprint 3 ports from ([e6e6b1d](https://github.com/VforVitorio/F1-StratLab/commit/e6e6b1def73f1fc4ed569d02e3f640f8d22047a8))
* **pitwall:** correct the data.py line numbers on the lap-glitch note ([00cf220](https://github.com/VforVitorio/F1-StratLab/commit/00cf22012f76349b054f2a5229ac6057aeb98ff9))
* **pitwall:** correct the sprint-4 rules the wire work refuted ([ec4e7cc](https://github.com/VforVitorio/F1-StratLab/commit/ec4e7ccb18c6207700d7397b4ded91bd38897d41))
* **pitwall:** decide the race-control question sprint 4 was gated on ([9b7927b](https://github.com/VforVitorio/F1-StratLab/commit/9b7927b03a6f566bcc267c0c926d39012fc4e02b))
* **pitwall:** describe the AGENTS window as it ships ([d6e2f2f](https://github.com/VforVitorio/F1-StratLab/commit/d6e2f2f5514647674cf63122a15d37baf525986d))
* **pitwall:** document the DATA window's other two tabs ([0a6f609](https://github.com/VforVitorio/F1-StratLab/commit/0a6f609e34bb2cd4351493f776169f5e02992a77)), closes [#1156](https://github.com/VforVitorio/F1-StratLab/issues/1156)
* **pitwall:** map every sprint-4 data source, and revoke a wrong scoping call ([8c98ce0](https://github.com/VforVitorio/F1-StratLab/commit/8c98ce0d23ed0c93c2d7f5aed282c8feb81c7ec6))
* **pitwall:** name the BROADCAST tag by its surface, and match the research to its evidence ([44f0086](https://github.com/VforVitorio/F1-StratLab/commit/44f0086b7924cefbd79115d8b8bd8970172f91c4))
* **pitwall:** name the prototype figures as prototype figures ([0cc2dad](https://github.com/VforVitorio/F1-StratLab/commit/0cc2dadbac4d2a206885edc2b7bb1487a2bc0c47))
* **pitwall:** put the telemetry band first in the DATA window ([92c1037](https://github.com/VforVitorio/F1-StratLab/commit/92c1037f892bbfd782a169b2a702522f78efc6eb))
* **pitwall:** record what sprint 5 measured, and what it deliberately left open ([d28066c](https://github.com/VforVitorio/F1-StratLab/commit/d28066c0482da751d144ac46a489ab6476e80c7a))
* **pitwall:** record what sprint 6 shipped and what it measured ([5e328e0](https://github.com/VforVitorio/F1-StratLab/commit/5e328e00500497e92e5d83a93bfb7f5b0afec3a4))
* **pitwall:** record what sprint 7 did, and that the promotion was deferred ([0985bbf](https://github.com/VforVitorio/F1-StratLab/commit/0985bbfb5267c5b2f4928ee546b355d693bc7338))
* **pitwall:** record why the pace row height is 12 px ([3f3c41c](https://github.com/VforVitorio/F1-StratLab/commit/3f3c41cdf2a1374ee7a0e67dcefd50b7bba0381c))
* **pitwall:** renumber the sprints the band reorder moved, two screens apart ([3072351](https://github.com/VforVitorio/F1-StratLab/commit/307235189551503b60314f4407bcafd901e20d5c))
* **pitwall:** state the crossing-skew convention, and what sprint 5 hands to sprint 6 ([94a1968](https://github.com/VforVitorio/F1-StratLab/commit/94a1968b7f3440b06c9c885c87e569ddcf525ac4))
* **pitwall:** the architecture doc promises two host methods that were never written ([272d091](https://github.com/VforVitorio/F1-StratLab/commit/272d091e86ea4caf90bcc25976d5a96a0145305d))
* **pitwall:** the DATA window's design gate ([08d5370](https://github.com/VforVitorio/F1-StratLab/commit/08d5370be21680282abed7bddfc289e05a0a60fa))
* **pitwall:** the delivery plan claimed sprint 4 shipped the stacked traces ([f78ec30](https://github.com/VforVitorio/F1-StratLab/commit/f78ec30fbe40f6beefa0c533bbd4a8ca041612ae))
* **pitwall:** the single promotion moves to the end of sprint 9 ([d14cddf](https://github.com/VforVitorio/F1-StratLab/commit/d14cddf87157c84bd1811d427c6b9a6fc62c3ddc))
* **pitwall:** the sprint-8 design gate on the AGENTS window ([427b4c6](https://github.com/VforVitorio/F1-StratLab/commit/427b4c6edf8189b56f28a509eafdae8865f5dc9a))
* **pitwall:** the sprint-8 exit gate ([ef56a14](https://github.com/VforVitorio/F1-StratLab/commit/ef56a14c669eaa044b38e16cbe26e11d6c20b393))
* **pitwall:** tidy the host, view and smoke-harness docstrings ([8a24650](https://github.com/VforVitorio/F1-StratLab/commit/8a246508183f5ef6219f6a81eaf484e03476d93c))
* **pitwall:** track the architecture, the delivery plan and both gate reports ([59d9b86](https://github.com/VforVitorio/F1-StratLab/commit/59d9b86090c784d2e27aa10e66f748690453d98e))
* **pitwall:** update the guardrail-line docstrings for the no-llm fix ([eee87ac](https://github.com/VforVitorio/F1-StratLab/commit/eee87acd8140187d70929a8470456f11a6e44c07))
* **readme:** lead with the PITWALL demo and show the three arcade windows ([1b6da2d](https://github.com/VforVitorio/F1-StratLab/commit/1b6da2dc613e67e29f0f0ac5b5af327f80664b7b))
* retire the 1810-stop figure from the code that quotes it too ([7044234](https://github.com/VforVitorio/F1-StratLab/commit/704423426e96b554120621cba5fc9818b9a09729))
* **roadmap:** mark the legacy-agent cleanup as done ([09dfe74](https://github.com/VforVitorio/F1-StratLab/commit/09dfe7414c3068efb4892eb2a989622c65f225ca))
* **roadmap:** the v2.6.0 entry now names the PIT EXIT card ([5a181b3](https://github.com/VforVitorio/F1-StratLab/commit/5a181b328365ada236163bd75d1d34e036d582d1))
* **roadmap:** v2.6.0 ships, so it moves out of the planned tables ([690b9b2](https://github.com/VforVitorio/F1-StratLab/commit/690b9b28bb24e5449d23d2e09d91e4f4c9c9ebc9))
* **site:** drop the changelog page, which duplicated GitHub and rotted proving it ([9998687](https://github.com/VforVitorio/F1-StratLab/commit/99986872c93e79d5d98f9f50b0cc8f0de93c0fcd)), closes [#909](https://github.com/VforVitorio/F1-StratLab/issues/909)
* **site:** fix everything the audit found, from a dead command to a deleted module ([1e42ce8](https://github.com/VforVitorio/F1-StratLab/commit/1e42ce85e34cf29a7a5c450caad58f4c6d22fe2a)), closes [#914](https://github.com/VforVitorio/F1-StratLab/issues/914)
* **site:** publish the corrected decision-agreement levels ([c43ab97](https://github.com/VforVitorio/F1-StratLab/commit/c43ab97e3ac4d89ba261e439740dd9291e83c6e2))
* **site:** retire the mixed-season projection headline and re-measure the bound calibration ([f465f9b](https://github.com/VforVitorio/F1-StratLab/commit/f465f9b56c617992afd7f1202571fb3bdba1f61a))
* **site:** the regeneration command now reproduces the headline it sits under ([34c09b4](https://github.com/VforVitorio/F1-StratLab/commit/34c09b48a6208d2be86084964c6609bcf56ecd34))


### Refactoring

* **arcade:** lay the replay out around the circuit ([73be2bf](https://github.com/VforVitorio/F1-StratLab/commit/73be2bf8f05b624729f81c25f0cf7e5c61918058)), closes [#1103](https://github.com/VforVitorio/F1-StratLab/issues/1103)
* **arcade:** one driver table instead of two stacked cards ([e879851](https://github.com/VforVitorio/F1-StratLab/commit/e879851ee445d5c3c8539b61ea5bb2d3b214214f)), closes [#1102](https://github.com/VforVitorio/F1-StratLab/issues/1102)
* **pitwall:** the tooltips return data, and the window decides how it looks ([7899fca](https://github.com/VforVitorio/F1-StratLab/commit/7899fca08a084cfe8c1bc1052a5c3246f6784513))
