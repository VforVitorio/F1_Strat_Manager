...
**The sprint-4 question is not "can we have them" but "where do they belong":** the flag STATE
...
Related: `PITWALL_DELIVERY_PLAN.md` section 5 (the sprint's rules) · `src/arcade/gaps.py` (the coordinate
