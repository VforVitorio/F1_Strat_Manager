...
def test_with_real_data(race_data_path, models_path):
    ...
    from N01_agent_setup import calculate_race_phase
...
def test_multiple_drivers(race_data_path, models_path, driver_numbers=None):
    ...
    from N01_agent_setup import load_tire_predictions
    predictions = load_tire_predictions(race_data, models_path)
    ...
    for driver in driver_numbers:
        ...
        from N01_agent_setup import transform_tire_predictions
        ...
        # Initialize engine
        from N01_agent_setup import F1StrategyEngine, RaceStatusFact
        engine = F1DegradationRules()
        engine.reset()
