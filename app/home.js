  ...
  return React.createElement("div", { className: "article-enter" },
    ...
    React.createElement("section", { className: "home-hero" },
      ...
      React.createElement("p", { className: "home-sub" },
        ...
        React.createElement("a", { href: "https://deepwiki.com/VforVitorio/F1-StratLab", target: "_blank", rel: "noopener noreferrer", style: { color: "var(--accent-text)" } }, "DeepWiki"),
        " and ",
        React.createElement("a", { href: "https://f1stratlab.com/", target: "_blank", rel: "noopener noreferrer", style: { color: "var(--accent-text)" } }, "the landing site"),
        ".",
      ),
      ...
      React.createElement("div", { className: "home-meta" },
        React.createElement("span", null, React.createElement("strong", null, "v2.6.1"), " current release"),
